    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div className="bg-white rounded-lg shadow-lg p-6 max-w-xs text-center">
        <h2 className="text-lg font-semibold text-gray-800 mb-4">
          Download the Giana Turkey Wear App
        </h2>
        <p className="text-gray-600 mb-4">
          Get a better experience by using the Giana Turkey Wear mobile app!
        </p>

        <a
          href="https://play.google.com/store/apps/details?id=ke.gianaturkeywear"
          target="_blank"
